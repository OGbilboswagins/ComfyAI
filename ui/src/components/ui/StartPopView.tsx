  ...
  return (
    <div id="comfyui-copilot-start-pop-view">
      ...
      </button>
      {
        showModal && (
          <div
            className="fixed !left-auto !top-auto right-16 bottom-16 text-gray-700 w-[300px] h-[280px] bg-white border border-gray-600 rounded-[12px] flex flex-col justify-center"
          >
            <div className="flex-1">
              ...
              <div className="text-gray-700 text-sm text-center mt-8 whitespace-pre-line">
                {startpopview_title}
              </div>
            </div>
            <button
              className="bg-gray-100 rounded-md flex justify-center items-center w-[240px] h-[40px] mx-[30px] mb-8"
