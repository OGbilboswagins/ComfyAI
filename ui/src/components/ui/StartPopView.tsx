  ...
  return (
    <div id="comfyui-copilot-start-pop-view">
      ...
      </button> */}
      {
        showModal && (
          <div
            className="fixed !left-auto !top-auto right-16 bottom-2 text-gray-700 w-[300px] h-[280px] bg-white border border-gray-600 rounded-[12px] flex flex-col justify-center shadow-[inset_0_0_12px_2px_#3b82f6] shadow-[inset_0_0_0_4px_rgba(59,130,246,0.15)]"
          >
            <div className="flex-1">
              ...
              <img 
                src={`.${gifImage}`}
                className="w-20 h-20 mt-2 justify-self-center"
              />
            </div>
            <button
